...
The model-strip `env -u` prefix `fm-spawn` applies at launch covers an Anthropic/Claude-specific variable family, verified live on the claude and codex launches and unverified on the opencode and pi launches.
