...
An always-on liveness daemon backstops the watcher while you are present and, in away mode (`/afk`), self-handles routine events and batches only what matters while you step away.
